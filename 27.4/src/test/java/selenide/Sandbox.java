...
public class Sandbox {
    ...
    @Test
//    поиск атрибута name с элементом заканчивающимся на order
    void findAttributeByValueEnd() { $("[name$=order]").click();
    }
    //    поиск атрибута name с элементом начинающимся на order
    void findAttributeByValueStart() { $("[name^=order]").click();
    }
